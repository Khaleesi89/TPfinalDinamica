...
<div id="bg" class="container-fluid d-flex justify-content-center p-5 my-1">
    <div class="row">
        <div class="col-sm-12">
            <table id="dg" title="Administrador de productos" class="easyui-datagrid" style="width:1000px; height:720px" url="accion/listar_producto.php" toolbar="#toolbar" pagination="true" fitColumns="true" singleSelect="true">
                <thead>
                    <tr>
                        <th field="foto" width="20%">Foto</th>
                        <th field="idproducto" width="3%">Id</th>
                        <th field="pronombre" width="25%">Nombre producto</th>
                        <th field="sinopsis" width="12%">Sinopsis</th>
                        <th field="procantstock" width="5%">Stock</th>
                        <th field="autor" width="12%">Autor</th>
                        <th field="precio" width="10%">Precio</th>
